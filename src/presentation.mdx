...
- This meant coming up with solutions to solve common problems:
  ...
  - Security
  - Audit
- How to share that data with other programs?
...
| ----------------------- | ------- | --- |
| SQL Server 1.0 (1989)   | 1.0    | 10  |
| SQL Server 4.2 (1993)   | 4.2    | 42  |
| SQL Server 6.0 (1995)   | 6.0    | 60  |
| SQL Server 6.5 (1996)   | 6.5    | 65  |
| SQL Server 7.0 (1998)   | 7.0    | 70  |
| SQL Server 2000         | 8.0     | 80  |
| SQL Server 2005         | 9.0     | 90  |
| SQL Server 2008         | 10.0    | 100 |
| SQL Server 2008R2       | 10.5    | 100 |
...
# SQL Server Editions
**Enterprise**	
The premium offering, datacenter capabilities, unlimited virtualization, mission-critical workloads.

**Standard ** 
Delivers basic data management. For departments and small organizations. 

**Web**	
Low cost option for Web hosters and Web VAPs

**Developer**	Free. Similar to Enterprise edition, but licensed for testing and dev, not as a production server. 
**Express** 	Free.  Entry-level database. For desktop apps and small server data apps. It is the best choice for independent software vendors, developers, and hobbyists building client applications. 
**Express LocalDB** Free.  Lightweight version of Express. Runs in user mode (like an app).  Installs quickly with zero-configuration. Has a short list of prerequisites.
